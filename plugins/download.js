...
cmd({
    ...
    try {
        const prog = await fetchJson(`https://sulamd-ytmp3.vercel.app/download?q=${q}&format=mp3&apikey=sadas2007`)
...
async (conn, mek, m, { from, q, reply }) => {
  ...
  try {
    const prog = await fetchJson(`https://sulamd-ytmp3.vercel.app/download?q=${encodeURIComponent(q)}&format=mp3&apikey=sadas2007`);
...
async (conn, mek, m, { from, q, reply }) => {
    try {
        ...
        const prog = await fetchJson(`https://sulamd-ytmp3.vercel.app/download?q=${datae}&format=mp3&apikey=sadas2007`);
