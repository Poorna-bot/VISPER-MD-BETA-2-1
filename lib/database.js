...
import config from '../config.js'; // Mehema '.js' extension eka danna ammathaka karanna epa

import { fileURLToPath } from 'url';

// __dirname manually create karaganna
const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

// Dan oyaage parana code eka pahalin thiyenna puluwan
